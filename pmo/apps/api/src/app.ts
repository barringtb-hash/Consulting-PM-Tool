...
export function createApp(): express.Express {
  ...
  // CRITICAL: Must be registered BEFORE tasksRouter and milestonesRouter because
  // those routers have router.use(requireAuth) which intercepts ALL /api/* requests
  // (even ones not matching their routes), blocking unauthenticated access to
  // /api/bug-tracking/external/* endpoints.
