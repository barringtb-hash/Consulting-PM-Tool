...
/**
 * Skeleton loader for stat cards during loading state
 */
    ...
    <Card>
      <CardBody className="py-3 sm:py-4">
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="p-2 bg-neutral-200 dark:bg-neutral-700 rounded-lg shrink-0 animate-pulse">
            <div className="w-4 h-4 sm:w-5 sm:h-5" />
          </div>
          <div className="min-w-0 flex-1">
            <div className="h-6 sm:h-8 w-12 bg-neutral-200 dark:bg-neutral-700 rounded animate-pulse mb-1" />
  ...
  return (
    <tr className="animate-pulse">
      ...
      <td className="px-6 py-4 whitespace-nowrap text-right">
        <div className="h-8 w-14 bg-neutral-200 dark:bg-neutral-700 rounded ml-auto" />
      </td>
    </tr>
  );
}
