    ...
    <div>
      ...
      <Section>
        <Container>
          {error && (
            <div
              className="mb-6 p-4 bg-danger-50 border border-danger-200 rounded-lg text-danger-800 flex items-center gap-2"
              role="alert"
            >
          ...
          {successMessage && (
            <div className="mb-6 p-4 bg-success-50 border border-success-200 rounded-lg text-success-800 flex items-center gap-2">
            ...
            <Card className="lg:col-span-3">
              ...
              <CardBody>
                {tenantConfigs[selectedTenant]?.loading ? (
                  ...
                  <div className="text-danger-600 py-4">
                    {tenantConfigs[selectedTenant].error}
                  </div>
                ) : (
