        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card>
            <CardBody>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-500">Anomaly Threshold</p>
          ...
          <Card>
            <CardBody>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-500">Auto Work Orders</p>
          ...
          <Card>
            <CardBody>
              <div className="flex items-center justify-between">
                ...
                <CheckCircle
                  className={`h-8 w-8 ${selectedConfig.isActive ? 'text-green-500' : 'text-gray-400'}`}
                />
              </div>
            </CardBody>
          </Card>
            ...
            {sensorsQuery.isLoading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {sensorsQuery.data?.map((sensor) => (
                  <div
                    key={sensor.id}
                    className={`border rounded-lg p-4 ${sensor.isAnomalous ? 'border-red-300 bg-red-50' : ''}`}
                  >
