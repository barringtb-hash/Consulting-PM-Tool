  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900">
      <PageHeader
        ...
        description="COMP.1 - HIPAA Privacy and Security Rule Implementation"
        icon={Heart}
        actions={
          <Button
            variant="secondary"
                  ...
                  <CardBody>
                    <div className="space-y-3">
                      {[
                        ...
                        {
                          label: 'Technical Safeguards Implementation',
                          done: true,
                        },
                        {
                        ...
                        {
                          label: 'Physical Safeguards Implementation',
                          done: true,
                        },
                        { label: 'BAA Templates Created', done: true },
                        {
                          label: 'Access Controls & Audit Logging',
                          done: true,
                        },
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button
                  variant="secondary"
                  size="sm"
                  onClick={() => handleComingSoon('New BAA')}
                >
                        ...
                        <tr key={baa.partnerId}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <Button
                              variant="secondary"
                              size="sm"
                              onClick={() => handleComingSoon('View BAA')}
                            >
                              View
                            </Button>
                          </td>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button
                  variant="secondary"
                  size="sm"
                  onClick={() => handleComingSoon('Schedule assessment')}
                >
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button
                  variant="secondary"
                  size="sm"
                  onClick={() => handleComingSoon('Assign training')}
                >
