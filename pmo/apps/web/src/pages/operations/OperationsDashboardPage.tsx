  ...
  const content = (
    <Card className="hover:shadow-md transition-shadow">
      <div className="p-6">
        <div className="flex items-center justify-between mb-4">
          <div
            className={`p-2 rounded-lg ${iconBgClass || 'bg-blue-100 dark:bg-blue-900/50'}`}
          >
            <Icon
              className={`w-5 h-5 ${iconColorClass || 'text-blue-600 dark:text-blue-400'}`}
            />
          </div>
          {trend && (
            <Badge
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900">
      <PageHeader
        ...
        description="AI usage, infrastructure health, and system monitoring"
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="text-center p-4 rounded-lg bg-neutral-50 dark:bg-neutral-800/50">
                      <div className="text-2xl font-bold text-primary-600 dark:text-primary-400">
                        {formatNumber(
                          realtimeStats?.data?.last1Hour?.calls || 0,
                        )}
                      </div>
                      <div className="text-xs text-neutral-500 dark:text-neutral-400 mt-1">
                        Last hour
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      {(realtimeStats?.data?.activeTools?.length || 0) ===
                        0 && (
