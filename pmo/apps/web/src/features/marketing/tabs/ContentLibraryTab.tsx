 ...
 * Content Library Tab
 *
 * Extracted from MarketingContentPage for use in the unified Marketing page.
 * Displays and manages marketing content with filtering and CRUD operations.
 */
...
import MarketingContentFormModal from '../MarketingContentFormModal';
import MarketingContentDetailModal from '../MarketingContentDetailModal';
...
export interface ContentLibraryTabProps {
  onNavigateToCalendar?: () => void;
}

export function ContentLibraryTab({
  onNavigateToCalendar,
}: ContentLibraryTabProps): JSX.Element {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          {onNavigateToCalendar && (
            <Button variant="secondary" onClick={onNavigateToCalendar}>
              View Calendar
            </Button>
          )}
